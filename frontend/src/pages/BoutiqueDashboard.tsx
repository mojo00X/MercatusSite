  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-4 space-y-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-5 flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-yellow-800 mt-1">
              Stripe still needs a few details before we can accept payments on
              your behalf and pay you out.
            </p>
          </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-5 flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-green-800 mt-1">
              You're set up to receive payouts on Stripe's schedule.
            </p>
          </div>
      ...
      <div className="bg-white border rounded-lg p-6 text-sm text-gray-600">
        <p>
          Products, orders, and stats are coming next — this dashboard will fill
          out as more of the boutique flow ships.
        </p>
      </div>
    </div>
  );
